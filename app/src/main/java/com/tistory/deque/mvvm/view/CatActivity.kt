...
class CatActivity : BaseKotlinActivity<ActivityCatBinding, CatViewModel>() {
    override val layoutResourceId: Int
        get() = R.layout.activity_cat
    ...
    private fun subscribeUi(binding: ActivityCatBinding) {
    ...
    private fun setView(binding: ActivityCatBinding) {
